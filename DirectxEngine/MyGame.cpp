...
void MyGame::UpdateObjectCBs(const GameTimer& gt)
{
...
void MyGame::UpdateMainPassCB(const GameTimer& gt)
{
...
void MyGame::BuildConstantBufferViews()
{
...
void MyGame::BuildShadersAndInputLayout()
{
	...
	mShaders["standardVS"] = d3dUtil::CompileShader(L"Shaders\\color.hlsl", skinnedDefines, "VS", "vs_5_1");
	...
	mInputLayout =
	{
		...
		{ "WEIGHTS", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, 28, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },
		{ "BONEINDICES", 0, DXGI_FORMAT_R8G8B8A8_UINT, 0, 40, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 }
	};
}

void MyGame::BuildShapeGeometry()
{
}

void MyGame::BuildPSOs()
{
