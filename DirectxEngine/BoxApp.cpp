...
bool BoxApp::Initialize()
{
	...
	squareMesh = new Mesh;
	squareMesh->LoadMeshData("", md3dDevice.Get(), mCommandList.Get());
...
void BoxApp::Draw(const GameTimer& gt)
{
	...
	mCommandList->IASetVertexBuffers(0, 1, &squareMesh->VertexBufferView());
	mCommandList->IASetIndexBuffer(&squareMesh->IndexBufferView());
    mCommandList->IASetPrimitiveTopology(D3D11_PRIMITIVE_TOPOLOGY_TRIANGLELIST);
    
    mCommandList->SetGraphicsRootDescriptorTable(0, mCbvHeap->GetGPUDescriptorHandleForHeapStart());

    mCommandList->DrawIndexedInstanced(
		squareMesh->subMeshArr[0].IndexCount,
		1, 0, 0, 0);
