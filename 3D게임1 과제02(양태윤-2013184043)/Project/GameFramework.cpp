...
#pragma region 초기화
bool CGameFramework::OnCreate(HINSTANCE hInstance, HWND hMainWnd)//메인윈도우가 만들어지면 호출된다.
{
...
void CGameFramework::CreateDirect3DDevice()
{
	...
	if (!pd3dAdapter)//못찾아서NULL이면 Warp모드로
	{
		m_pdxgiFactory->EnumWarpAdapter(_uuidof(IDXGIFactory4), (void **)&pd3dAdapter);
		hResult = D3D12CreateDevice(pd3dAdapter, D3D_FEATURE_LEVEL_12_0,IID_PPV_ARGS(&m_pd3dDevice));
	}
...
void CGameFramework::ChangeSwapChainState()
{
	...
	//후면버퍼의 모든 버퍼들도 다 release해주고 다시 만든다.
	DXGI_SWAP_CHAIN_DESC dxgiSwapChainDesc;
	...
	CreateRenderTargetViews();//렌더타깃뷰생성
}
#pragma endregion
...
void CGameFramework::OnProcessingKeyboardMessage(HWND hWnd, UINT nMessageID, WPARAM wParam, LPARAM lParam)
{
	switch (nMessageID)
	{
        case WM_KEYUP:
			...
			case VK_F2:
			case VK_F3:
				if (m_pPlayer) m_pPlayer->ChangeCamera((wParam - VK_F1 + 1),
...
void CGameFramework::Restart()
{
	m_pPlayer->m_hp = 3;
	m_pPlayer->m_item = 0;
	m_pPlayer->SetPosition(XMFLOAT3(0.0f, 0.0f, -50.0f));
	m_pBoss->m_hp = 10;
	m_pScene->Restart();
}
...
void CGameFramework::BuildObjects()
{
	...
	/////////////////////////////////////////////////////////////
	m_pBoss = new CBoss(m_pd3dDevice,
		m_pd3dCommandList, m_pScene->GetGraphicsRootSignature());
	////////////////////////////////////////////////////////////
	m_pScene->SetPlayerAndBoss(m_pPlayer, m_pBoss);
	if (m_pScene) m_pScene->CreateShader(m_pd3dDevice, m_pd3dCommandList);
	////////////////////////////////////////////////////////////
...
void CGameFramework::ProcessInput()
{
	...
	m_pBoss->Animate(m_GameTimer.GetTimeElapsed());
}
...
void CGameFramework::WaitForGpuComplete()
{
	...
	{
		hResult = m_pd3dFence->SetEventOnCompletion(nFenceValue, m_hFenceEvent);//gpu가 할 일 할때까지 기다리고 있겠다.
...
void CGameFramework::FrameAdvance()
{
	...
	m_pScene->SpawnObjects(m_pd3dDevice, m_pd3dCommandList);
	...
	if (m_pBoss)m_pBoss->Render(m_pd3dCommandList, m_pCamera);
